			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="td.elemPresentationCell2">
						<fo:block>
							<fo:inline font-weight="bold">Completion term:</fo:inline>

							<xsl:value-of select="termDesc/value" />
							<fo:block></fo:block>
							<fo:inline font-weight="bold">Granted:</fo:inline>

							<xsl:value-of select="degrConferDt/value" />
