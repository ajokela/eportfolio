/* $Name:  $ */
/* $Id: Certificates.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $ */
/*
 * $Header: /opt/UMN-src/portfolio/src/org/portfolio/model/Certificates.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $
 * $Revision: 1.7 $
...
/**
 * This class encapsulates Certificates element object.
 *
 * @author	John Bush
 * @since	0.0
 * @version	$Revision: 1.7 $
 */
public class Certificates extends ElementBase {

    private static final long serialVersionUID = -997949301784716316L;
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if ((entryName == null) || (entryName.trim().length() == 0)) {
            errors.add("entryName", new ActionMessage("error.required.missing", "Name of certificate"));
            ...
            errors.add("entryName", new ActionMessage("error.lengthTooLong", "Name of certificate", PortfolioConstants.SIXTY_CHARS_DESC ));
        }

        if ( DateValidation.checkDate( getRcdDateMonth(), getRcdDateYear() ) == DateValidation.FAILURE ) {
            errors.add( "rcdDate", new ActionMessage( "error.date.invalid", "Date recevied" ) );
        }
        //Organization
