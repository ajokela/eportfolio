/* $Name:  $ */
/* $Id: CoCurricular.java,v 1.13 2010/10/27 19:24:57 ajokela Exp $ */
/*
 * $Header: /opt/UMN-src/portfolio/src/org/portfolio/model/CoCurricular.java,v 1.13 2010/10/27 19:24:57 ajokela Exp $
 * $Revision: 1.13 $
...
/**
 * This class encapsulates CoCurricular element object.
 *
 * @author	John Bush
 ...
 */
public class CoCurricular extends ElementBase {

    private static final long serialVersionUID = 3399724219266192472L;
...
//This is better
        ...
        int dateValid = DateValidation.checkDate( getFromDateMonth(), getFromDateYear(), true );
...
*/
// this is better
        int dateValid2 = DateValidation.checkDate( getToDateMonth(), getToDateYear(), true );
        if ( dateValid2 == DateValidation.MISSING_REQUIRED ) {
            errors.add( "toDate", new ActionMessage( "error.date.invalid", "To" ) );
        } else if ( dateValid2 == DateValidation.FAILURE ) {
            errors.add( "toDate", new ActionMessage( "error.date.invalid", "To" ) );
        }
