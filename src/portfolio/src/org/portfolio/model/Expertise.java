/* $Name:  $ */
/* $Id: Expertise.java,v 1.13 2010/10/27 19:24:57 ajokela Exp $ */
/*
 * $Header: /opt/UMN-src/portfolio/src/org/portfolio/model/Expertise.java,v 1.13 2010/10/27 19:24:57 ajokela Exp $
 * $Revision: 1.13 $
...
/**
 * This class encapsulates Expertise element object.
 *
 * @author	John Bush
 ...
 */
public class Expertise extends ElementBase {

    private static final long serialVersionUID = -7140096333234928798L;
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if ((entryName == null) || (entryName.trim().length() == 0)) {
            errors.add("entryName", new ActionMessage("error.required.missing", "Area of expertise"));
            ...
            errors.add("entryName", new ActionMessage("error.lengthTooLong", "Area of expertise", PortfolioConstants.FIFTY_CHARS_DESC));
        }
