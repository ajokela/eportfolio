/* $Name:  $ */
/* $Id: Scholarships.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $ */
/*
 * $Header: /opt/UMN-src/portfolio/src/org/portfolio/model/Scholarships.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $
 * $Revision: 1.7 $
...
/**
 * This class encapsulates Scholarships element object.
 *
 * @author	John Bush
 * @author      Jack Brown
 * @since	0.0
 ...
 */
public class Scholarships extends ElementBase {

    private static final long serialVersionUID = 3573765072929540102L;
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if ((entryName == null) || (entryName.trim().length() == 0)) {
            errors.add("entryName", new ActionMessage("error.required.missing", "Name of scholarship"));
            ...
            errors.add("entryName", new ActionMessage("error.lengthTooLong", "Name of scholarship", PortfolioConstants.SIXTY_CHARS_DESC));
        }
