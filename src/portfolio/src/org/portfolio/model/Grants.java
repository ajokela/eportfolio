/* $Name:  $ */
/* $Id: Grants.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $ */
/*
 * $Header: /opt/UMN-src/portfolio/src/org/portfolio/model/Grants.java,v 1.7 2010/10/27 19:24:57 ajokela Exp $
 * $Revision: 1.7 $
...
/**
 * This class encapsulates Grants element object.
 *
 * @author	John Bush
 * @author      Jack Brown
 * @since	0.0
 ...
 */
public class Grants extends ElementBase {

    private static final long serialVersionUID = -534032078625310887L;
    ...
    public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
        ...
        if ((entryName == null) || (entryName.trim().length() == 0)) {
            errors.add("entryName", new ActionMessage("error.required.missing", "Name of grant"));
            ...
            errors.add("entryName", new ActionMessage("error.lengthTooLong", "Name of grant", PortfolioConstants.SIXTY_CHARS_DESC));
        }
